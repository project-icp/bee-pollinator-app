...
After the `staging-deployment` job completes, `staging.app.beescape.org` should reflect the current release. Be sure to run any outstanding database migrations or data imports.
...
Within 60 seconds, `app.beescape.org` should reflect the current release.
