...
STATSD_HOST = environ.get('ICP_STATSD_HOST', 'localhost')
# END STATSD CONFIGURATION

# STACK COLOR CONFIGURATION
STACK_COLOR = environ.get('ICP_STACK_COLOR', 'Black')
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://{0}:{1}/1'.format(
            environ.get('ICP_CACHE_HOST', 'localhost'),
            environ.get('ICP_CACHE_PORT', 6379)),
        'OPTIONS': {
...
DATABASES = {
    'default': {
        ...
        'NAME': environ.get('ICP_DB_NAME', 'icp'),
        'USER': environ.get('ICP_DB_USER', 'icp'),
        'PASSWORD': environ.get('ICP_DB_PASSWORD', 'icp'),
        'HOST': environ.get('ICP_DB_HOST', 'localhost'),
        'PORT': environ.get('ICP_DB_PORT', 5432),
        'TEST_NAME': environ.get('DJANGO_TEST_DB_NAME', 'test_icp')
    }
}
...
STATICFILES_DIR = '/var/cache/icp/static/'
STATICFILES_DIRS = (
    STATICFILES_DIR,
)
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'icp.context_processors.google_analytics_account',
)
...
MIDDLEWARE_CLASSES = (
    ...
    'icp.middleware.BypassMiddleware',
